...
let count = [0];
const contentTimer = document.querySelector('#content');
let placeForCount = document.createElement("div");
...
function haveFood(unit) {
    ...
    if (unit_classes.includes('food-unit')) {
        ...
        score++;
        count++;
        placeForCount.innerHTML = count;
        wrapper.appendChild(placeForCount);
    }
    return check;
}
...
function finishTheGame() {
    ...
    console.log('Вы проиграли! Ваш результат: ' + score.toString());
}
